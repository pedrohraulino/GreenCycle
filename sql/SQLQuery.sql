...
(
    ...
    FOREIGN KEY(ClienteCPF) REFERENCES tbClientes2(CPF) ON DELETE SET NULL
);

CREATE TABLE tbPedidos2Itens1
(
    PedidoID int,
    ProdutoID int,
    Qtde int,
    ...
    FOREIGN KEY(PedidoID) REFERENCES tbPedidos2(ID),
    FOREIGN KEY(ProdutoID) REFERENCES tbProdutos2(ID)
);


--- questão 1

INSERT INTO tbProdutos2 (Codigo, Descricao, Grupo, Preco)
VALUES
...
INSERT INTO tbClientes2 (CPF, Nome, Cidade, Bairro)
VALUES
    ('0000001', 'Cliente 01', 'Cidade 01', 'Bairro 01');

INSERT INTO tbPedidos2 (Pedido, Data, ClienteCPF)
VALUES
    ('0001', '2024-08-19 09:32:20', '0000001');

INSERT INTO tbPedidos2Itens1 (PedidoID, ProdutoID, Qtde, Unitario, Desconto)
VALUES
    (1, 1, 10, 30.00, 0),
    (1, 2, 5, 35.00, 0);
...
FROM tbPedidos2 pedido
    INNER JOIN tbClientes2 cliente ON pedido.ClienteCPF = cliente.CPF
    INNER JOIN tbPedidos2Itens1 item ON item.PedidoID = pedido.ID
    INNER JOIN tbProdutos2 produto ON item.ProdutoID = produto.ID
...
DELETE FROM tbClientes2 WHERE CPF = '0000001';


--- questão 11

DELETE item
FROM tbPedidos2Itens1 item
    INNER JOIN tbProdutos2 produto ON item.ProdutoID = produto.ID
